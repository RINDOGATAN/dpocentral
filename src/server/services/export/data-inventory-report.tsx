...
import { FlowGraphSvg } from "./flow-graph-pdf";
        ...
        {data.flows.length > 0 && (
          <>
            ...
            <Text style={[s.paragraph, { fontSize: 8, color: "#6B7280" }]}>
              Solid lines: explicit flows. Dotted lines: auto-generated from activity links.
              Direction left-to-right: source asset → destination asset.
            </Text>
            <View wrap={false}>
              <FlowGraphSvg
                assets={data.assets.map((a) => ({ id: a.id, name: a.name, type: a.type }))}
