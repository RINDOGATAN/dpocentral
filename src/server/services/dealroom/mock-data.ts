...
export const mockExperts: ExpertProfile[] = [
  ...
  {
    id: "exp-002",
    name: "Carlos Fernández de Landa",
    email: "info@privacycloud.com",
    title: "Privacy Counsel",
    firm: "TODO.LAW",
    bio: "Data protection lawyer specialising in GDPR compliance, international data transfers, and privacy programme implementation. Advises organisations on data mapping, DSAR management, and regulatory engagement across EU Member States.",
    expertTypes: ["legal"],
    specializations: [
      "GDPR",
      "DPIA / Impact Assessments",
  ...
  },
  {
    ...
    firm: "PrivacyCloud",
    bio: "Infrastructure and deployment specialist helping organisations self-host DPO Central on their own infrastructure — Docker, Kubernetes, bare metal, or private cloud. Experienced in privacy-by-design architectures and secure hosting environments.",
